...
router.post('/', [
    ...
    check('pruebas.pruebaFrenos.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaSuspension.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaLuces.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaMotor.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaAlineacion.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaContaminacion.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaTrenDelantero.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaTrenTrasero.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaCinturones.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
    ...
    check('pruebas.pruebaMatafuego.puntaje', 'Debe ser un número').not().isEmpty().isNumeric(),
